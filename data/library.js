let lib1 = [
    ...
    { 
        ...
        title: 'Honkai Impact 3rd OST / 崩坏3rd / 崩壊3rd  • Complete',
    ...
    { 
        ...
        title: 'Cradles – Sub Urban',
        description: 'By Blue'
    },
    { 
        image: './assets/img/lib_page/img_5.jpg',
        title: 'Can We Kiss Forever? – Kina',
        description: 'By Blue'
    },
    { 
    ...
    { 
        ...
        title: 'Daily Mix 3',
        description: 'Orinn, Thùy Chi, Khải and more'
    },
    { 
        image: './assets/img/lib_page/img_10.jpg',
        title: 'K-Pop Ngay Lúc Này',
        description: 'BTS, LISA, TWICE, aespa... fan K-Pop còn cần gì hơn lúc này? Ảnh bìa: JEON SOMI'
    },
    { 
    ...
    { 
        ...
        description: 'Essential tracks from "Resident Evil" series. 25周年を迎えたホラーゲームの金字塔、バイオハザードシリーズの音楽をプレイリストで。©CAPCOM CO., LTD. ALL RIGHTS RESERVED.'
    },
    { 
        image: './assets/img/lib_page/img_14.jpg',
        title: 'Indie Mix',
        description: 'The Cassette, Minh Tốc & Lam, Groovie Lã Thắng and more'
    },
    { 
    ...
    { 
        ...
        description: 'Những nghệ sĩ nam góp phần rạng rỡ cho V-Pop. Ảnh bìa: Vũ.'
    },
    { 
    ...
    { 
        ...
        description: 'Trendy & Chill 한국 R&B. Be laid-back with groovy K-R&B. (Cover: msftz)'
    }
]
...
let lib4 = [
    ...
    },
    {
        ...
        description: 'Bich Phuong, Phúc Du'
    },
    {
